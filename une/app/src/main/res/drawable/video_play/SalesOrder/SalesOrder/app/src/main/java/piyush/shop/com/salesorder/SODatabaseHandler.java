...
public class SODatabaseHandler extends SQLiteOpenHelper {
    ...
    public long countProductsBySupplierName(String supplierName, boolean stockWise) {
        ...
        long count = 0;
        String selectQuery = "SELECT  * FROM " + PRODUCT_TABLE_NAME + " WHERE " + KEY_SUPPLIER + "= '" + supplierName + "'";
    ...
    public List<Product> getAllProductsByCategoryName(String category, String subCaterogy) {
        ...
        List<Product> productList = new ArrayList<Product>();
        String selectQuery = "SELECT  * FROM " + PRODUCT_TABLE_NAME + " WHERE " + KEY_CATEGORY + "= '" + category + "' and " +
                KEY_SUB_CATEGORY + "= '" + subCaterogy + "'";
    ...
    public List<String> getSubCategories(String category) {
        ...
        String selectQuery = "SELECT  * FROM " + SUB_CATEGORY_TABLE_NAME + " WHERE " + KEY_CATEGORY + "= '" + category + "'";
