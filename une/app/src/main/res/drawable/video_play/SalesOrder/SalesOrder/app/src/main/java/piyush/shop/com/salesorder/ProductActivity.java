...
public class ProductActivity extends Activity {
    ...
    CompleteCategoryAdapter mCategoryAdapter;
...
//                mProductAdapter.imagesMap.clear();
    ...
    private void showCapturedImageDialog() {
        ...
        ivConfirmImage.setImageBitmap(SOUtility.tempBmp);
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btmHolder = soUtility.getResizedBitmap(SOUtility.tempBmp, 100, 100);
    ...
    public void showProductDialog(final Product product, final int position) {
        ...
        spMainCategory.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Product product = mProductAdapter.mProductList.get(productIndex);
