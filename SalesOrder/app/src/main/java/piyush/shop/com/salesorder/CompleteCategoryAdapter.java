...
public class CompleteCategoryAdapter extends BaseExpandableListAdapter {
    ...
    public AddProductViewForMobile addProductViewForMobileContext;
    ...
    private void deleteMainCategoryData(final int groupPos, final Dialog dialog, final Dialog parentDialog) {
    ...
    private void showMainCategoryPwdProtectionDialog(final int groupPos, final Dialog parentDialog) {
            ...
            public void onClick(View v) {
                ...
                if (pwd.equals(SOUtility.PASSWORD)) {
                    ...
                    new Thread(new Runnable() {
                        @Override
                        public void run() {
                            deleteMainCategoryData(groupPos, dialog, parentDialog);
                        }
                    }).start();
    ...
    private void showDeleteMainCategoryDialog(final int groupPos, final String category) {
        ...
        btnDialogOK.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showMainCategoryPwdProtectionDialog(groupPos, dialog);
            }
        });
    ...
    private void deleteSubCategoryData(final int groupPos, final String subCategory, final Dialog dialog,
    ...
    private void showSubCategoryPwdProtectionDialog(final int groupPos, final String subCategory, final Dialog parentDialog) {
            ...
            public void onClick(View v) {
                ...
                if (pwd.equals(SOUtility.PASSWORD)) {
                    ...
                    new Thread(new Runnable() {
                        @Override
                        public void run() {
                            deleteSubCategoryData(groupPos, subCategory, dialog, parentDialog);
                        }
                    }).start();
    ...
    private void showDeleteSubCategoryDialog(final int groupPos, final int childPos, final String subCategory) {
        ...
        btnDialogOK.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showSubCategoryPwdProtectionDialog(groupPos, subCategory, dialog);
            }
        });
